...
"en/python-selenium-example.md": {
	id: "en/python-selenium-example.md";
  slug: "en/python-selenium-example";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
...
"python-selenium-example.md": {
	id: "python-selenium-example.md";
  slug: "python-selenium-example";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"webpack-stats-file.md": {
	id: "webpack-stats-file.md";
  slug: "webpack-stats-file";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
